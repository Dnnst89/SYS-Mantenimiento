...
export const metadata = {
  ...
  description:
    "Así es como trabajamos, etapas del servicio, preguntas frecuentes y cotización — mantenimiento integral con procesos claros.",
};
...
export default function ServiciosPage() {
  return (
    <div className="flex flex-1 flex-col">
      <HomeHero locale="es" />
      <BrandsCarousel locale="es" />
      <ServicesHowWeWorkSection locale="es" />
